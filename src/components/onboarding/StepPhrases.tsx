  ...
  return (
    <div className="space-y-3">
      <p className="text-sm text-muted">
        {isSelf
          ? 'Add up to 5 things you say often. Relay passes them to your local model as context so interpretations match how you usually talk.'
          : 'Add up to 5 things they say most days. They are included when the local model interprets so tone and intent stay familiar.'}
      </p>
