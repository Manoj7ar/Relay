...
| Emergency | **Real** when proxy URL + phone set | Harden HTTPS proxy + server-side carrier logic |
...
- [ ] **Settings → Integrations**: document that emergency only works with your HTTPS proxy.
